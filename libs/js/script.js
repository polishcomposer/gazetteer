...
var map = L.map('map').setView([userLat, userLong], 6);
     L.easyButton('<img src="libs/img/covid.png" style="width:100%;" alt="covid" title="COVID-19">',  function (){
      $('#myModal').modal('show');
    }).addTo(map);
